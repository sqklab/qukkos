...
#ifndef KOKKOS_XACC_PARALLEL_SCAN_RANGE_HPP
#define KOKKOS_XACC_PARALLEL_SCAN_RANGE_HPP
...
// XACC features: Clacc does not fully support private clauses for
...
class ParallelScanXACCBase {
 ...
 public:
  ParallelScanXACCBase(Functor const& arg_functor, Policy const& arg_policy,
  ...
  // work-efficient.
  void XACCParallelScanRangePolicy(const IndexType begin,
...
#endif
    Kokkos::View<ValueType*, Kokkos::Experimental::XACCSpace> chunk_values(
        "Kokkos::XACCParallelScan::chunk_values", n_chunks);
    Kokkos::View<ValueType*, Kokkos::Experimental::XACCSpace> offset_values(
        "Kokkos::XACCParallelScan::offset_values", n_chunks);
    Kokkos::View<ValueType, Kokkos::Experimental::XACCSpace> m_result_total(
        "Kokkos::XACCParallelScan::m_result_total");
...
#pragma acc loop vector
    ...
    if (!m_result_ptr_device_accessible && m_result_ptr != nullptr) {
      DeepCopy<HostSpace, Kokkos::Experimental::XACCSpace,
               Kokkos::Experimental::XACC>(m_policy.space(), m_result_ptr,
                                              m_result_total.data(),
                                              sizeof(ValueType));
    }
...
#pragma acc exit data delete (functor, chunk_values, offset_values, \
  ...
  void execute() const {
    ...
    XACCParallelScanRangePolicy(begin, end, chunk_size, async_arg);
  }
};
...
class Kokkos::Impl::ParallelScan<Functor, Kokkos::RangePolicy<Traits...>,
    ...
    : public ParallelScanXACCBase<Functor, void, Traits...> {
  using base_t    = ParallelScanXACCBase<Functor, void, Traits...>;
 ...
 public:
  void execute() const {
    ...
    base_t::XACCParallelScanRangePolicy(begin, end, chunk_size, async_arg);
  }
...
class Kokkos::Impl::ParallelScanWithTotal<
    ...
    Kokkos::Experimental::XACC>
    : public ParallelScanXACCBase<FunctorType, ReturnType, Traits...> {
  using base_t    = ParallelScanXACCBase<FunctorType, ReturnType, Traits...>;
  using IndexType = typename base_t::IndexType;
