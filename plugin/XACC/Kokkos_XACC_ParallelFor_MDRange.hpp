...
#ifndef KOKKOS_XACC_PARALLEL_FOR_MDRANGE_HPP
#define KOKKOS_XACC_PARALLEL_FOR_MDRANGE_HPP
...
void XACCParallelForMDRangePolicy(XACCCollapse, XACCIterateLeft,
...
template <class Functor>
void XACCParallelForMDRangePolicy(XACCCollapse, XACCIterateRight,
                                     Functor const& functor,
                                     XACCMDRangeBegin<2> const& begin,
                                     XACCMDRangeEnd<2> const& end,
                                     int async_arg) {
...
template <class Functor>
void XACCParallelForMDRangePolicy(XACCTile, XACCIterateLeft,
                                     Functor const& functor,
                                     XACCMDRangeBegin<2> const& begin,
                                     XACCMDRangeEnd<2> const& end,
                                     XACCMDRangeTile<2> const& tile,
                                     int async_arg) {
  auto tile0  = tile[0];
  auto tile1  = tile[1];
  auto begin1 = begin[1];
...
template <class Functor>
void XACCParallelForMDRangePolicy(XACCTile, XACCIterateRight,
                                     Functor const& functor,
                                     XACCMDRangeBegin<2> const& begin,
                                     XACCMDRangeEnd<2> const& end,
                                     XACCMDRangeTile<2> const& tile,
...
class Kokkos::Impl::ParallelFor<Functor, Kokkos::MDRangePolicy<Traits...>,
 ...
 public:
  ...
  void execute() const {
...
#if 0  // FIXME_XACC: XACC requires tile size to be constant.
    for (int i = 0; i < rank; ++i) {
      if (m_policy.m_tile[i] < 1) {
        Kokkos::Experimental::Impl::XACCParallelForMDRangePolicy(
            Kokkos::Experimental::Impl::XACCCollapse(),
    ...
    Kokkos::Experimental::Impl::XACCParallelForMDRangePolicy(
        Kokkos::Experimental::Impl::XACCTile(),
