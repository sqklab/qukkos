...
#ifndef KOKKOS_XACC_PARALLEL_FOR_RANGE_HPP
#define KOKKOS_XACC_PARALLEL_FOR_RANGE_HPP
...
void XACCParallelForRangePolicy(Schedule<Static>, int chunk_size,
...
template <class IndexType, class Functor>
void XACCParallelForRangePolicy(Schedule<Dynamic>, int chunk_size,
                                   IndexType begin, IndexType end,
                                   Functor afunctor, int async_arg) {
  // FIXME_XACC FIXME_NVHPC workaround compiler bug (incorrect scope
  // analysis)
...
class Kokkos::Impl::ParallelFor<Functor, Kokkos::RangePolicy<Traits...>,
  ...
  Kokkos::Experimental::Impl::FunctorAdapter<
      ...
      m_functor;
  Policy m_policy;
  using ScheduleType = Kokkos::Experimental::Impl::XACCScheduleType<Policy>;
 ...
 public:
  ...
  void execute() const {
    ...
    Kokkos::Experimental::Impl::XACCParallelForRangePolicy(
