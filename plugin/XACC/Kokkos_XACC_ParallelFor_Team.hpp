...
#ifndef KOKKOS_XACC_PARALLEL_FOR_TEAM_HPP
#define KOKKOS_XACC_PARALLEL_FOR_TEAM_HPP
...
class Kokkos::Impl::ParallelFor<FunctorType, Kokkos::TeamPolicy<Properties...>,
 ...
 private:
  using Policy = Kokkos::Impl::TeamPolicyInternal<Kokkos::Experimental::XACC,
                                                  Properties...>;
...
#else  // KOKKOS_ENABLE_XACC_COLLAPSE_HIERARCHICAL_CONSTRUCTS
...
#endif /* #ifndef KOKKOS_XACC_PARALLEL_FOR_TEAM_HPP */
