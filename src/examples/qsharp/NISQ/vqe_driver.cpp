...
// qukkos -qdk-version 0.17.2106148041-alpha deuteron.qs vqe_driver.cpp 
// Note: the first qreg argument is implicit.
qukkos_import_qsharp_kernel(QUKKOS__ansatz, double);
...
int main() {
  ...
  auto problemModel = QuaSiMo::ModelFactory::createModel(QUKKOS__ansatz, H, 2, 1);
