...
qukkos_include_qsharp(QUKKOS__DeuteronVqe__body, double, int64_t shots, Callable* opt_stepper);
...
int main() {
  // Create an optimizer:
  qukkos::OptStepper qukkosOptimizer("nlopt", {{"maxeval", 20}});
  ...
  const double final_energy = QUKKOS__DeuteronVqe__body(
