...
// Compile with:
// qukkos -qrt ftqc op_takes_callable.qs kernel.qasm driver.cpp -v
...
extern "C" void QUKKOS__ApplyControlledKernel__body(::Callable *);
...
int main() {
  ...
  // QUKKOS__ApplyKernelToEachQubit__body(qasm3_callable);
  ...
  for (int i = 0; i < COUNT; ++i) {
    std::cout << "Run " << i + 1 << ":\n";
    QUKKOS__ApplyControlledKernel__body(qasm3_callable);
  }
  return 0;
}