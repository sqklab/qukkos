...
// qukkos -set-credentials honeywell
// qukkos ghz.cpp -qpu honeywell:HQS-LT-S1-SIM -shots 1024
// (3) Run with IonQ 
// qukkos ghz.cpp -qpu ionq -shots 1024
// (4) Run with OLCF QLM simulator (QLMaaS)
// qukkos ghz.cpp -qpu atos-qlm -shots 1024
// (5) Run with just print_kernel to show automatic placement
// Uncomment print_kernel
// qukkos ghz.cpp -qpu ibm:ibmq_toronto
