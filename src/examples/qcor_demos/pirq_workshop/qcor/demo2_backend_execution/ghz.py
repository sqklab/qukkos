...
# GHZ kernel expressed as QUKKOS's qjit
# from qukkos import qreg, set_shots
# @qjit
# def ghz(q : qreg):
#   H(q[0])
...
# Convert Qiskit circuit to QUKKOS IR
qukkos_kernel = qjit(qiskit_circ)

# Allocate the qreg
q = qalloc(3)

# Examine the QUKKOS IR:
print('QUKKOS IR:')
qukkos_kernel.print_kernel(q)
