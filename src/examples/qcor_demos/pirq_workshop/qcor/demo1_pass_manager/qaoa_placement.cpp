...
/// qukkos -qpu aer:ibmq_guadalupe  qaoa_placement.cpp -print-final-submission
/// Change the placement:
/// qukkos -qpu aer:ibmq_guadalupe -placement enfield qaoa_placement.cpp -print-final-submission
