// To use the QUKKOS JIT utilities 
// just include the qukkos_jit.hpp header
#include "qukkos_jit.hpp"

int main() {

  // QJIT is the entry point to QUKKOS quantum kernel 
  ...
  // Note, if QUKKOS QJIT has not seen this kernel 
  // source code before, it will run through the 
  // entire JIT compile process. If you have run 
  // this JIT compile before, QUKKOS QJIT will read a 
