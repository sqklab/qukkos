...
std::unique_ptr<clang::CodeGenAction> emit_llvm_ir(
  ...
  std::string internal_file_name = ".__qukkos_internal_llvm_ir_emitter.cpp";
  ...
  std::vector<std::string> base_includes{
      ...
      "-I@CMAKE_INSTALL_PREFIX@/include/qukkos",
  ...
  if (!C) {
    std::cout << "QUKKOS internal clang execution error. Could not create the "
