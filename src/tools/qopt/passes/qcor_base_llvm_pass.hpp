...
// qukkos FunctionPasses, specifically, a mechanism for only
// operating on Functions that are annotated quantum
class QUKKOSBaseFunctionPass : public FunctionPass {
protected:
  const char *AnnotationString = "quantum";

  QUKKOSBaseFunctionPass(char pid) : FunctionPass(pid) {}
