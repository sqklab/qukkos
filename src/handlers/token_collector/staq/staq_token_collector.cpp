...
public:
  ...
  void Start(BundleContext context) {
    auto st = std::make_shared<qukkos::StaqTokenCollector>();
    context.RegisterService<qukkos::TokenCollector>(st);
  }
...
void StaqTokenCollector::collect(clang::Preprocessor &PP,
  ...
  auto visitor = std::make_shared<qukkos::qrt_mapper>(inst->name());
