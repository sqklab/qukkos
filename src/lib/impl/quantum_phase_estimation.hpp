...
// Common QUKKOS kernels to support iterative Quantum Phase Estimation algorithm.

// First-order Trotter evolution
__qpu__ void pauli_trotter_evolution(qreg q, qukkos::PauliOperator pauli_ham,
...
__qpu__ void pauli_power_trotter_evolution(qreg q,
                                           qukkos::PauliOperator pauli_ham,
                                           double evo_time, int num_time_slices,
                                           int power) {
...
__qpu__ void pauli_qpe_iter(qreg q, int k, double omega,
                            qukkos::PauliOperator pauli_ham, int num_time_slices,
                            int measure) {
