...
xx = measure qqq;
  ...
  auto mlir = qukkos::mlir_compile(measure_test, "measure_test",
                                 qukkos::OutputType::MLIR, false);
  std::cout << "MLIR:\n" << mlir << "\n";
  // qukkos::execute(measure_test, "test");
}
...
cx q, qq[1];
  ...
  auto mlir = qukkos::mlir_compile(qinst_test, "qinst_test",
                                 qukkos::OutputType::MLIR, false);
  std::cout << "MLIR:\n" << mlir << "\n";
}
...
for i in [0:4] {
 for j in {1,2,3} {
  ...
  qukkos::execute(for_stmt, "for_stmt");
}
...
print(b1,b2,b3,b4);
  ...
  auto mlir = qukkos::mlir_compile(uint_index, "uint_index",
                                 qukkos::OutputType::MLIR, false);
  std::cout << mlir << "\n";
  qukkos::execute(uint_index, "uint_index");
}
...
if ( cc[1] == 1) {
  ...
  auto mlir = qukkos::mlir_compile(if_stmt, "if_stmt",
                                 qukkos::OutputType::MLIR, false);
  std::cout << mlir << "\n";
}
...
print("hi world");
  ...
  auto mlir = qukkos::mlir_compile(if_stmt, "if_stmt",
                                 qukkos::OutputType::MLIR, false);
  std::cout << mlir << "\n";
  qukkos::execute(if_stmt, "if_stmt");
}
...
if(temp==0 && i==3) {
  ...
  auto mlir = qukkos::mlir_compile(complex_if, "complex_if",
                                 qukkos::OutputType::MLIR, false);
  std::cout << mlir << "\n";
  qukkos::execute(complex_if, "complex_if");
}
...
while (i < 10) {
  ...
  auto mlir = qukkos::mlir_compile(while_stmt, "while_stmt",
                                 qukkos::OutputType::MLIR, false);
  std::cout << mlir << "\n";
  qukkos::execute(while_stmt, "while_stmt");
}
...
r = xmeasure qq[0];
  ...
  auto mlir = qukkos::mlir_compile(subroutine_test, "subroutine_test",
                                 qukkos::OutputType::MLIR, false);
...
ans[1:3] = measure b[1:3];
  ...
  auto mlir = qukkos::mlir_compile(meas_range, "meas_range",
                                 qukkos::OutputType::MLIR, false);
...
print(t);
  ...
  auto mlir2 = qukkos::mlir_compile(cast_int, "cast_int",
                                  qukkos::OutputType::LLVMIR, false);

  std::cout << "cast_int MLIR:\n" << mlir2 << "\n";
  qukkos::execute(cast_int, "cast_int");
}
...
rz(x) q;
  ...
  auto mlir = qukkos::mlir_compile(built_in_math, "built_in_math",
                                 qukkos::OutputType::MLIR, false);

  std::cout << "cast_int MLIR:\n" << mlir << "\n";
  auto llvm = qukkos::mlir_compile(built_in_math, "built_in_math",
                                 qukkos::OutputType::LLVMIR, false);
  std::cout << "LLVM:\n" << llvm << "\n";
}
...
// }
  ...
  auto mlir = qukkos::mlir_compile(while2, "while2",
                                 qukkos::OutputType::MLIR, false);

  std::cout << "cast_int MLIR:\n" << mlir << "\n";
  auto llvm = qukkos::mlir_compile(while2, "while2",
                                 qukkos::OutputType::LLVMIR, false);
  std::cout << "LLVM:\n" << llvm << "\n";
    qukkos::execute(while2, "while2");
