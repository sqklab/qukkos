...
public:
  ...
  enum {
    ...
    RuleStatement = 5, RuleCompute_action_stmt = 6, RuleQukkos_test_statement = 7, 
  ...
  class Qukkos_test_statementContext;
  ...
  public:
    ...
    Qukkos_test_statementContext *qukkos_test_statement();
  ...
  class  Qukkos_test_statementContext : public antlr4::ParserRuleContext {
  public:
    Qukkos_test_statementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
