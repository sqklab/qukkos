...
qasm3Parser::Qukkos_test_statementContext* qasm3Parser::StatementContext::qukkos_test_statement() {
  return getRuleContext<qasm3Parser::Qukkos_test_statementContext>(0);
}
...
//----------------- Qukkos_test_statementContext ------------------------------------------------------------------

qasm3Parser::Qukkos_test_statementContext::Qukkos_test_statementContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* qasm3Parser::Qukkos_test_statementContext::LPAREN() {
  return getToken(qasm3Parser::LPAREN, 0);
}

qasm3Parser::BooleanExpressionContext* qasm3Parser::Qukkos_test_statementContext::booleanExpression() {
  return getRuleContext<qasm3Parser::BooleanExpressionContext>(0);
}

tree::TerminalNode* qasm3Parser::Qukkos_test_statementContext::RPAREN() {
  return getToken(qasm3Parser::RPAREN, 0);
}

tree::TerminalNode* qasm3Parser::Qukkos_test_statementContext::SEMICOLON() {
  return getToken(qasm3Parser::SEMICOLON, 0);
}


size_t qasm3Parser::Qukkos_test_statementContext::getRuleIndex() const {
  return qasm3Parser::RuleQukkos_test_statement;
}

void qasm3Parser::Qukkos_test_statementContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<qasm3Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterQukkos_test_statement(this);
}

void qasm3Parser::Qukkos_test_statementContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<qasm3Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitQukkos_test_statement(this);
}


antlrcpp::Any qasm3Parser::Qukkos_test_statementContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<qasm3Visitor*>(visitor))
    return parserVisitor->visitQukkos_test_statement(this);
  else
    return visitor->visitChildren(this);
}

qasm3Parser::Qukkos_test_statementContext* qasm3Parser::qukkos_test_statement() {
  Qukkos_test_statementContext *_localctx = _tracker.createInstance<Qukkos_test_statementContext>(_ctx, getState());
  enterRule(_localctx, 14, qasm3Parser::RuleQukkos_test_statement);
...
std::vector<std::string> qasm3Parser::_ruleNames = {
  ...
  "compute_action_stmt", "qukkos_test_statement", "quantumDeclarationStatement", 
...
std::vector<std::string> qasm3Parser::_literalNames = {
  "", "'OPENQASM'", "'include'", "'compute'", "'action'", "'QUKKOS_EXPECT_TRUE'", 
