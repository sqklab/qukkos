...
public:
  ...
  virtual void enterQukkos_test_statement(qasm3Parser::Qukkos_test_statementContext * /*ctx*/) override { }
  virtual void exitQukkos_test_statement(qasm3Parser::Qukkos_test_statementContext * /*ctx*/) override { }
