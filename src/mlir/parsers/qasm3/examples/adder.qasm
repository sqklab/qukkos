...
// Using DM-Sim:
// qukkos -linker g++ -qrt nisq adder.qasm -shots 1024 -qpu dm-sim[gpus:4]
...
// QUKKOS: (must add paths to the specific gcc module paths)
// cmake .. -DXACC_DIR=~/.xacc -DLLVM_ROOT=~/.llvm -DMLIR_DIR=~/.llvm/lib/cmake/mlir -DQUKKOS_BUILD_TESTS=TRUE -DCMAKE_BUILD_TYPE=Debug -DQUKKOS_EXTRA_HEADERS="/sw/summit/gcc/9.3.0-2/include/c++/9.3.0/powerpc64le-unknown-linux-gnu/;/sw/summit/gcc/9.3.0-2/include/c++/9.3.0/"
...
// Install DM-SIM plugin: qukkos -install-plugin https://github.com/ORNL-QCI/DM-Sim.git
