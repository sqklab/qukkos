...
std::shared_ptr<qukkos::IRTransformation> createTransformation(
...
std::shared_ptr<qukkos::CompositeInstruction> create_composite(std::string name) {
  return std::make_shared<CompositeInstruction>(
      xacc::getIRProvider("quantum")->createComposite(name));
}
std::shared_ptr<qukkos::CompositeInstruction> create_ctrl_u() {
  return std::make_shared<CompositeInstruction>(
      std::dynamic_pointer_cast<xacc::CompositeInstruction>(
          xacc::getService<xacc::Instruction>("C-U")));
}

std::shared_ptr<qukkos::CompositeInstruction> create_and_expand_ctrl_u(
    HeterogeneousMap &&m) {
...
std::shared_ptr<qukkos::IRTransformation> get_transformation(
    const std::string &transform_type) {
...
std::shared_ptr<qukkos::IRProvider> get_provider() {
  return xacc::getIRProvider("quantum");
}

std::shared_ptr<qukkos::CompositeInstruction> decompose_unitary(
